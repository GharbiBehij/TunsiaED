...
import { loginWithGoogle } from '../../lib/auth';  // ← seulement loginWithGoogle
 ...
 function GoogleLoginButton() {
    ...
    const handleGoogle = async () => {
      try {
        await loginWithGoogle();  // This is ALL you need
        // onAuthStateChanged will do the navigation automatically
      } catch (err) {
        console.log("Google cancelled or failed (normal)");
      }
    };
