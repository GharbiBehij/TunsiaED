...
const SIDEBAR_CONFIG = {
  ...
  instructor: [
    { label: "My Classes", icon: "video_library", path: "/dashboard/instructor" },
  ...
  student: [
    ...
    { label: "Browse Courses", icon: "search", path: "/courses" },
  ],
};
...
export default function Sidebar() {
  ...
  const role = isAdmin ? 'admin' : isInstructor ? 'instructor' :isStudent ? 'student' : 'student';
    ...
    <aside className="fixed top-0 left-0 h-full w-72 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 flex flex-col">
      ...
      <div className="p-6 border-b border-gray-200 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-primary">TunisiaED</h1>
      ...
      <div className="p-4 border-t border-gray-200 dark:border-gray-800">
        <button className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition">
