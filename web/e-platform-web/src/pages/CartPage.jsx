  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      if (promoApplied && promoCode) {
        ...
        purchaseData.promoDiscount = promoDiscount;
      ...
      <div className="min-h-screen bg-background-light dark:bg-background-dark">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-2xl mx-auto text-center">
            <div className="mb-6">
              <span className="material-symbols-outlined text-gray-400 dark:text-gray-600" style={{ fontSize: '120px' }}>
                shopping_cart
              </span>
            </div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="w-8 h-8 flex items-center justify-center rounded-lg border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:border-primary hover:text-primary transition"
